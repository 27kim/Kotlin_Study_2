...
//    {x1 + x2}
    ...
    ln("; 로 끊어줘야지 아래에 쓸 수 있음 왜 그럴까???")
    var lambdaResult = test2(10, 20);
    ...
    println("그냥 lambda1을 찍으면 $lambda1")
    println("lambda1(inputData) 을 찍으면 ${lambda1(inputData)}")
    ln("""
        테스트를 해보자면
...
""")
    ...
    val memberTest = User::age
    ln("멤버 참조 연습용")
    println(memberTest(User("Kim", 4)))
